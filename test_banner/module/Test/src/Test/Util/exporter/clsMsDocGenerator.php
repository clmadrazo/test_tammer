...
class clsMsDocGenerator{
	 ...
	 */
	function __construct($pageOrientation = 'PORTRAIT', $pageType = 'A4', $cssFile = '', $topMargin = 3.0, $rightMargin = 2.5, $bottomMargin = 3.0, $leftMargin = 2.5){
		$this->documentBuffer = '';
		$this->formatBuffer = '';
